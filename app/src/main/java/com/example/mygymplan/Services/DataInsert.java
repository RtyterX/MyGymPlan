    ...
    public void PopulateDatabase(Context context) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                // - Workout 1 - \\
                workoutDao.rawInsert("Workout A", "From Database", WorkoutType.Chest, 1, "", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 1, false);
                // Exercises:

                // - Workout 2 - \\
                workoutDao.rawInsert("Workout B", "From Database", WorkoutType.Back, 2, "", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 1, false);
                // Exercises:

                // - Workout 3 - \\
                workoutDao.rawInsert("Workout C", "From Database", WorkoutType.Leg, 3, "", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 1, false);
                // Exercises:
                ...
                // - Workout 4 - \\
                workoutDao.rawInsert("Chest", "", WorkoutType.Chest, 1, "50 - 80min", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 2, false);
                // Exercises:
                ...
                // - Workout 5 - \\
                workoutDao.rawInsert("Back", "", WorkoutType.Back, 2, "50 - 80min", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 2, false);
                // Exercises:
                ...
                // - Workout 6 - \\
                workoutDao.rawInsert("Leg", "", WorkoutType.Leg, 3, "50 - 80min", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 2, false);
                // Exercises:
                ...
                // - Workout 7 - \\
                workoutDao.rawInsert("Arm", "", WorkoutType.Arm, 4, "50 - 80min", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 2, false);
                // Exercises:
                ...
                // - Workout 8 - \\
                workoutDao.rawInsert("Chest", "", WorkoutType.Chest, 1, "", null, LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM")), 3, false);
                // Exercises:
